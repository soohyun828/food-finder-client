...
class JapanesePage extends StatefulWidget {
  ...
  @override
  _JapanesePageState createState() => _JapanesePageState();
}
...
class _JapanesePageState extends State<JapanesePage> {
      ...
      Column(
        children: [
          SizedBox(
            ...
            child: Image.asset('assets/japanese.jpg', fit: BoxFit.contain),
          ),
          const SizedBox(height: 15),
          Row(
            children: [
              buildCategoryButton('초밥'),
              buildCategoryButton('라멘'),
              buildCategoryButton('소바'),
              buildCategoryButton('텐동'),
            ],
          ),
          const SizedBox(height: 15),
          Expanded(
  ...
  Future<void> fetchRestaurants(String menu) async {
    try {
      ...
      final url = Uri.parse('$serverURL/home/japanese/$menu/$username/$latitude/$longitude');
