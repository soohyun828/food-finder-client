...
class _FastfoodPageState extends State<FastfoodPage> {
      ...
      Column(
        children: [
          SizedBox(
            ...
            child: Image.asset('assets/fastfood.jpg', fit: BoxFit.contain),
          ),
          const SizedBox(height: 15),
          Row(
            children: [
              buildCategoryButton('라면'),
              buildCategoryButton('떡볶이'),
              buildCategoryButton('피자'),
              buildCategoryButton('치킨'),
            ],
          ),
          const SizedBox(height: 15),
          Expanded(
  ...
  Future<void> fetchRestaurants(String menu) async {
    try {
      ...
      final url = Uri.parse('$serverURL/home/fastfood/$menu/$username/$latitude/$longitude');
