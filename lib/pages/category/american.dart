...
class AmericanPage extends StatefulWidget {
  ...
  @override
  _AmericanPageState createState() => _AmericanPageState();
}
...
class _AmericanPageState extends State<AmericanPage> {
      ...
      Column(
        children: [
          SizedBox(
            ...
            child: Image.asset('assets/american.jpg', fit: BoxFit.contain),
          ),
          const SizedBox(height: 15),
          Row(
            children: [
              buildCategoryButton('피자'),
              buildCategoryButton('스테이크'),
              buildCategoryButton('핫도그'),
              buildCategoryButton('버거'),
            ],
          ),
          const SizedBox(height: 15),
          Expanded(
  ...
  Future<void> fetchRestaurants(String menu) async {
    try {
      ...
      final url = Uri.parse('$serverURL/home/american/$menu/$username/$latitude/$longitude');
