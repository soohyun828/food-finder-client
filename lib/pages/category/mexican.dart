...
class _MexicanPageState extends State<MexicanPage> {
      ...
      Column(
        children: [
          SizedBox(
            ...
            child: Image.asset('assets/mexican.jpg', fit: BoxFit.contain),
          ),
          const SizedBox(height: 15),
          Row(
            children: [
              buildCategoryButton('부리또'),
              buildCategoryButton('타코'),
              buildCategoryButton('퀘사디아'),
              buildCategoryButton('파히타'),
            ],
          ),
          const SizedBox(height: 15),
          Expanded(
  ...
  Future<void> fetchRestaurants(String menu) async {
    try {
      ...
      final url = Uri.parse('$serverURL/home/mexican/$menu/$username/$latitude/$longitude');
